...
class RollbackCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'grnspc:rollback:addresses {--f|force : Force the operation to run when in production.}';
     ...
     * @var string
     */
    protected $description = 'Rollback Grnspc Addresses Tables.';
